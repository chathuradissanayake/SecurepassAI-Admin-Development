        ...
        <div className="max-h-96 overflow-y-auto">
          <ul>
            {requests.map((request) => (
              <Link to={`/users/${request.user._id}`} key={request._id} className="block bg-gray-100 p-4 rounded-lg hover:bg-gray-200 mb-2 dark:bg-slate-700 dark:hover:bg-slate-800 dark:text-slate-300">
